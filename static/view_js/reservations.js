...
$(document).ready(function () {
  ...
  $("#invitesTable tr td:nth-last-child( " + eventDateIndex + " )").each(
    function () {
...
function displayNoEventsHeader() {
  if ($(".tableBody").children().length == 0) {
    var noEventsLabel = $(
      '<h3> You are not Reserved for any Events <img src="static/images/NoEventsImg.png" height="100" width="100"></h3>'
    );
