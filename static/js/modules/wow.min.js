      ...
      { target: "Array", proto: !0, forced: !f("slice") },
      {
        slice: function (t, n) {
          ...
          if (
            ...
            return p.call(h, y, m);
          for (
            e = new (void 0 === r ? Array : r)(v(m - y, 0)), f = 0;
            y < m;
            y++, f++
          )
            y in h && s(e, f, h[y]);
              ...
              o(".wow").each(function () {
                if (
                  ...
                  ((n + r - 100 > e(this) && r < e(this)) ||
                    (n + r - 100 > e(this) + o(this).height() &&
                      r < e(this) + o(this).height()) ||
                    (n + r == o(document).height() &&
                      e(this) + 100 > o(document).height()))
                ) {
                  ...
                  if (a) {
                    ...
                    var u =
                      1e3 * o(this).css("animation-duration").slice(0, -1);
                  ...
                  ? ((t = window.innerHeight),
                    ...
                    o(".wow.animated").each(function () {
                      if (
                        ...
                        o(this).attr("data-wow-delay") &&
                          (n +=
                            1e3 * o(this).attr("data-wow-delay").slice(0, -1));
                        var r = this;
                        setTimeout(function () {
