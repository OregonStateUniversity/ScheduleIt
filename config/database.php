...
class DatabaseInterface
{
  ...
  //get a timeslot hash from a start time and event hash
    ...
    public function getMeetingsBySearchTerm($onid, $search_term)
    {
        ...
        $partial_match = '%' . $search_term . '%';
        $bookings->bind_param("sssss", $onid, $onid, $partial_match, $partial_match, $partial_match);
        $bookings->execute();
    ...
    public function getMeeting($id, $onid)
    {
        $bookings_query = "
    ...
    public function getMeetingAttendees($id, $onid)
    {
        $bookings_query = "
        ...
        $bookings = $this->database->prepare($bookings_query);
        $bookings->bind_param("is", $id, $onid);
        $bookings->execute();
